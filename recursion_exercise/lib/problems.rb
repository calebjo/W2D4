...
def sum_array(array)
    ...
    sum_array([array[0]]) + sum_array(array[1...array.length])
end
...
def reverse_string(str)
    ...
    # range of 2nd to last + first
    reverse_string(str[1 .. -1]) + reverse_string(str[0])
end
...
def flatten(data)
    ...
    data.each do |sub_arr| # iterates through each sub_arr ele, adding their eles
        flat += flatten(sub_arr)
    end
